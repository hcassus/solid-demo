...
import soliddemo.ocp.deps.post.PortfolioCalculatorPost
...
fun main() {
    ...
    val portfolioCalculator = PortfolioCalculatorPost()
    ...
    val totalStocksUpd = portfolioCalculator.totalizeAssetsUpdated(stockPurchases)         // Assinatura mantida
    val totalCurrencyUpd = portfolioCalculator.totalizeAssetsUpdated(currencyPurchases, 2) // Assinatura extendida
